<section class="top-header desktop" style="background-color:#3399FF">
    <div class="container">
        <div class="content">
            <div class="left">
...
<section class="top-header mobile" style="background-color:#3399FF!important;">
    <div class="container">
        <div class="content">
            <div class="left">
                <a href="{{ route('get.static.customer_care') }}" title="Chăm sóc khách hàng" rel="nofollow">Chăm sóc khách hàng</a>
...
<div class="commonTop" style="position: unset !important;">
    <div id="headers" style="background-color:#3399FF!important;">
        <div class="container header-wrapper">
            <!--Thay đổi-->
            <div class="logo">
                <a href="{{  route('get.home') }}" class="desktop">
                    <img src="{{ asset('images/logo.png') }}" style="height: 35px; width:90px" alt="Home">
                </a>
            ...
            <div class="search">
                ...
                <form action="{{ $link_search ?? route('get.product.list',['k' => Request::get('k')]) }}" role="search" method="GET">
                    ...
                    <button type="submit" class="btnSearch" style="background-color:#3399FF!important;">
