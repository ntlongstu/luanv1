        ...
        <div class="card-body info-detail">
            <div class="left">
                ...
                <a href="{{ route('get.product.detail',$product->pro_slug . '-'.$product->id ) }}" title="" class="">
                    <img alt="" style="max-width: 100%;width: 100%;height: 500px" src="{{ pare_url_file($product->pro_avatar) }}" class="lazyload">
                </a>
            </div>
            <div class="right" id="product-detail" data-id="{{ $product->id }}">
                ...
                <div class="right__content">
                    <div class="info" style="width: 500px">
                        @if ( $product->pro_number <= 0 ) <p class="text-danger" style="font-size: 14px;margin-bottom: 5px;background: #dedede;padding: 5px;">Sản phẩm đã hết hàng</p>
                            @endif
                            <div class="prices">
                                @if ($product->pro_sale)
                                <p>Giá niêm yết:
                            ...
                            <div class="btn-cart">
                                <a href="{{ route('get.shopping.add', $product->id) }}" title="" onclick="add_cart_detail('17617',0);" class="muangay {{ $product->pro_number <= 0 ? 'number-empty' : '' }}">
                                    <span>Mua ngay</span>
                                    <span>Hotline:0839744377</span>
                                </a>
                                <a href="{{ route('ajax_get.user.add_favourite', $product->id) }}" title="Thêm sản phẩm yêu thích" class="muatragop  {{ !\Auth::id() ? 'js-show-login' : 'js-add-favourite' }}">
                                    <span>Yêu thích</span>
                                    <span>Sản phẩm</span>
                                </a>
                            </div>
