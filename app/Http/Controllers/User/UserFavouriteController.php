...
class UserFavouriteController extends Controller
{
    ...
    {
        if ($request->ajax()) {// check tk ajax bằng js ko loading lại trang

            //1.  Kiểm tra tồn tại sản phẩm
            $product = Product::find($id);//tránh tình trạng admin xóa sản phẩm rồi mà user chưa loading lại trang
